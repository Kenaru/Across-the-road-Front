...
class CMSAdmin extends Component {
  ...
  render() {
    ...
    return (
      <Box bg="#010132" >
        <Center>
          <Box bg="#010132" display="flex" justifyContent="center" width="100%">
            {/* Sidebar 1 */}
            <Box width="40%" margin="20px" height="100vh" overflowY="auto">
              ...
              <Box p="20px" boxShadow="md" borderRadius="lg" bg="green" color="black" mb="20px" textAlign="center">
                ...
                <Text color="black" fontSize="md">Number of Websites: {numWebsites}</Text>
              </Box>
            ...
            {/* Sidebar 2 */}
            <Box width="50%" margin="auto" height="100vh" overflowY="auto">
              <Heading as="h1" size="xl" mb="40px" color="white" textAlign="center">
                Website Pages
              </Heading>
              <SimpleGrid columns={[1, 2, 3]} spacing="40px">
